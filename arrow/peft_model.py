...
from arrow.lora_model import LoraModel
...
from arrow.layer import Linear
    ...
    **Attributes**:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        from arrow.mapping import MODEL_TYPE_TO_PEFT_MODEL_MAPPING, PEFT_TYPE_TO_CONFIG_MAPPING
    ...
    def load_adapter(
        ...
        **kwargs: Any,
        ...
        """
        from arrow.mapping import PEFT_TYPE_TO_CONFIG_MAPPING
    ...
    def init_svd(self, adapter_name):
        module_list = [module for key, module in self.named_modules()]
        for module in module_list:
            if not isinstance(module, Linear):
                continue
            module.init_svd(adapter_name)
